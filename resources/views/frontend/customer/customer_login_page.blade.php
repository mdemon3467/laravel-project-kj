                        ...
                        <form class="wpo-accountWrapper" action="{{route('customer.login.post')}}" method="POST">
                            ...
                            <div class="wpo-accountInfo">
                                <div class="wpo-accountInfoHeader">
                                    ...
                                    <a class="wpo-accountBtn" href="{{route('customer.registar.page')}}">
                            ...
                            <div class="wpo-accountForm form-style">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            @enderror
                                            @if (session('password'))
                                                <strong class="text-danger">{{session('password')}}</strong>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-12">
                                ...
                                <p class="subText">Don't have an account? <a href="{{route('customer.registar.page')}}">Create free
                                        account</a></p>
                            </div>
                        </form>
                    </div>

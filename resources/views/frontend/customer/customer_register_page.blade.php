    ...
    <div class="page-wrapper">
        ...
        <div class="wpo-login-area">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <form class="wpo-accountWrapper" action="{{route('customer.register.post')}}" method="POST">
                            @csrf
                            <div class="wpo-accountInfo">
                                <div class="wpo-accountInfoHeader">
                                    <a href="index.html"><img src="{{asset('frontend')}}/images/logo-2.svg" alt=""></a>
                                    <a class="wpo-accountBtn" href="{{route('customer.login.page')}}">
                            ...
                            <div class="wpo-accountForm form-style">
                                ...
                                <p class="subText">Sign into your pages account <a href="{{route('customer.login.page')}}">Login</a></p>
                            </div>
                        </form>
                    </div>
                </div>

                ...
                <div class="featured-categorie-slider owl-carousel">
                    ...
                    <div class="featured-item">
                        <div class="images mb-5">
                            <a href="{{route('category.wise.product',$category->slug)}}"><img src="{{asset('uploads/category')}}/{{$category->category_photo}}" alt=""></a>
                        </div>
                        <div class="text">
                            <h2><a href="{{route('category.wise.product',$category->slug)}}">{{$category->category_name}}</a></h2>
                        </div>
                    </div>
                    @endforeach
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="offer-wrap" style="background-image: url({{asset('uploads/countdown/'.$countdowns->first()->bg_image)}})">
                            <div class="content">
                                <h2>{{$countdowns->first()->product_name}}</h2>
                                <span class="offer-price">&#2547;{{$countdowns->first()->after_discount}}</span>
                                <del>&#2547;{{$countdowns->first()->price}}</del>

                                <div class="count-up">
                                    <div id="clock" value="2050/10/10"></div>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="banner-two-wrap" style="background-image: url({{asset('uploads/discount_event/'.$event->first()->bg_image)}})">
                            <div class="text">
                                <h2>{{$event->first()->event_name}}</h2>
                                <h4>Up To {{$event->first()->discount}}% Off</h4>
                                <a class="theme-btn-s2" href="{{route('discount.product.70')}}">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                            <div class="product-item">
                                ...
                                @endphp
                                <div class="text">
                                    <h2 title="{{$product->product_name}}"><a href="{{route('product.details',$product->slug)}}">{{ $length >= "25" ? Str::substr($product->product_name, 0, 20).'...' : $product->product_name }}</a></h2>
                                    ...
                                    <div class="price">
                                        ...
                                        <span class="present-price">
                                            &#2547;{{$product->rel_to_inventory->first()->price}}
                                        </span>
                                        @endif
            ...
            <div class="container">
                <div class="upcoming-offer">
                    ...
                    <div class="left-image">
                        <img src="{{asset('uploads/upcoming_event/'.$upcoming_event->first()->product_image)}}" alt="">
                    </div>
                    ...
                    <div class="right-image">
                        <img src="{{asset('uploads/upcoming_event/'.$upcoming_event->first()->model_image)}}" alt="">
                    </div>
                    <div class="section-title-text">
                        <h2>{{$upcoming_event->first()->event_name}}</h2>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="text">
                                <div class="shape-text">Up To <div class="shape-single">
                                        ...
                                        {{$upcoming_event->first()->discount}}
                                    </div>% Off</div>
                                <a class="upcoming-btn" href="{{route('discount.product.50')}}">Shop Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="highlight-wrap">
                            ...
                            <div class="product-card">
                                <div class="card-image">
                                    <div class="image">
                                        <img style="width: 100px; hight: 100px" src="{{asset('uploads/product/preview/'.$recent->preview)}}" alt="">
                                    </div>
                                </div>
                                <div class="content">

                                    @php
                                    $length = Str::length($recent->product_name);
                                    @endphp


                                    <h3><a href="{{route('product.details',$recent->slug)}}">{{ $length >= "25" ? Str::substr($recent->product_name, 0, 20).'...' : $recent->product_name }}</a></h3>
                                    <div class="rating-product">
                                        <i class="fi flaticon-star"></i>
                                        <i class="fi flaticon-star"></i>
                                        <i class="fi flaticon-star"></i>
                                    ...
                                    <div class="price">
                                        @if ($recent->discount)
                                            <span class="present-price">&#2547;{{$recent->rel_to_inventory->first()->after_discount}}</span>
                                            <del class="old-price">&#2547;{{$recent->rel_to_inventory->first()->price}}</del>
                                        @else         
                                        <span class="price">
                                            &#2547;{{$recent->rel_to_inventory->first()->price}}
                                        </span>
                                        @endif
                                    </div>
                                </div>
...
<script>
    if ($("#clock").length) {
            // let $copytext =document.getElementById('clock').value;
        $('#clock').countdown('{{$countdowns->first()->end_date}}', function (event) {

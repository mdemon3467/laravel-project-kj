	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="uiComponents">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{route('add.category')}}" class="nav-link">Add Categories</a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('add.variation')}}" role="button">
		  ...
		  <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#uiComponent" role="button" aria-expanded="false" aria-controls="uiComponents">
              <i class="link-icon" data-feather="feather"></i>
            ...
            <div class="collapse" id="uiComponent">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{route('count.down')}}" class="nav-link">Count-Down_Offer</a>
                </li>
                <li class="nav-item">
                  <a href="{{route('discount.event')}}" class="nav-link">Discount event</a>
                </li>
              </ul>
            </div>
          </li>
		  <li class="nav-item">
            <a class="nav-link" href="{{route('upcoming.event')}}">
              <i class="link-icon" data-feather="bell"></i>
              <span class="link-title">Upcaming Offer</span>
            </a>
          </li>
